        ...
        <div class="row vh-100">
            ...
            <div class="col-2" style="border-right: 2px solid gray">
                <div class="row container vh-100 align-items-center m-1">
                    <div>
                        <img src="./styles/assets/car-icon.png" alt="" class="profile-picture rounded-circle">
                    </div>
                    <div class="row gap-2">
            ...
            <div class="col-7 bg-light text-center p-4" style="border-right: 2px solid gray">
                <div style="display: flex; justify-content: space-between;">
                    ...
                    <p><a href="#" style="background: linear-gradient(to right, #00FF00, #00AA00); color: white; text-align: right; border-radius: 5px; padding: 5px 30px; text-decoration: none;" class="aBtn">Add</a></p>
                </div>
